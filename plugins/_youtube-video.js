...
if (!m.quoted.text.includes("乂 Y͙̾ O͙̾ U͙̾ T͙̾U͙̾ B͙̾ E͙̾  -  P͙̾ L͙̾ A͙̾ Y͙̾ ")) return conn.reply(m.chat, `[ 💠 ] Etiqueta el mensaje que contenga el resultado de YouTube Play.`, m, rcanal).then(_ => m.react('✖️'))
