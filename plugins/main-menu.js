...
`
    ...
    let botInfo = `
.    ╭─ׅ─ׅ┈ ─๋︩︪─🎵⃘̸࣭ٜ࣪࣪࣪۬◌⃘۪֟፝֯۫۫︎⃪𐇽۫۬💙⃘⃪۪֟፝֯۫۫۫۬◌⃘࣭ٜ࣪࣪࣪۬🎵︎︎︎̸─ׅ─ׅ┈ ─๋︩︪─╮
╭╼🎧⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪ 🄼🄸🄺🅄-🄱🄾🅃໑⃪࣭۪ٜ݊݊݊݊𑁍ꥈ࣪⬪🎧
┃֪࣪  ╰─ׅ─ׅ┈ ─๋︩︪─🎵⃘̸࣭ٜ࣪࣪࣪۬◌⃘۪֟፝֯۫۫︎⃪𐇽۫۬💙⃘⃪۪֟፝֯۫۫۫۬◌⃘࣭ٜ࣪࣪࣪۬🎵︎︎︎̸─ׅ─ׅ┈ ─๋︩︪─╯
├ׁ̟̇❍✎ *🅅ᴏᴄᴀʟᴏɪᴅ:* MIKU
├ׁ̟̇❍✎ *Creador:* DEPOOL
├ׁ̟̇❍✎ *🄼ᴏᴅᴏ:* Digital
├ׁ̟̇❍✎ *🄻ɪʙʀᴇʀɪᴀ:* Crypton
